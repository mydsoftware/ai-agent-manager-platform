...
function jwtSecret() { const value = process.env.JWT_SECRET || 'dev-change-me-in-production-min-32-chars'; if (value.length < 32) throw new Error('JWT_SECRET must be at least 32 characters'); return new TextEncoder().encode(value) }
